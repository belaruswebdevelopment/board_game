 ...
 *
 * @type {{amount: (function(): {"2": {"0": number, "1": number}, "3": {"0": number, "1": number}, "4": {"0": number, "1": number}, "5": {"0": number, "1": number}}), action: {config: {number: number, value: number}, actionName: string}, value: number}} Карта улучшения монеты.
 */
