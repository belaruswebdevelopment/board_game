...
export class GameBoard extends React.Component {
    render() {
        var _a;
        const gridClass = `col-span-4`, classes = `col-span-4 text-center underline border`, tierCardsUI = DrawTierCards(this.props), currentPlayerTurnUI = DrawCurrentPlayerTurn(this.props), winnerUI = DrawWinner(this.props), marketCoinsUI = DrawMarketCoins(this.props), drawHeroesUI = DrawHeroes(this.props), drawCampUI = ((_a = this.props.G.expansions.thingvellir) === null || _a === void 0 ? void 0 : _a.active) ? DrawCamp(this.props) :
