...
export class GameBoard extends React.Component {
    render() {
        var _a;
        const gridClass = `col-span-4 justify-self-center`, classes = `col-span-4 text-center underline border`, tierCardsUI = DrawTierCards(this.props.G), currentPlayerTurnUI = DrawCurrentPlayerTurn(this.props.ctx), winnerUI = DrawWinner(this.props.G, this.props.ctx), drawDiscardCards = DrawDiscardedCards(this.props.G, this.props.ctx, null, this.props), marketCoinsUI = DrawMarketCoins(this.props.G, this.props), drawHeroesUI = DrawHeroes(this.props.G, this.props.ctx, null, this.props), drawCampUI = ((_a = this.props.G.expansions.thingvellir) === null || _a === void 0 ? void 0 : _a.active) ?
