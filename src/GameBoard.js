...
export class GameBoard extends React.Component {
    render() {
        const gridClasses = `col-span-4 justify-self-center`, gridColClasses = `h-full flex flex-col justify-evenly`, classes = `col-span-3 text-center underline border`, tierCardsUI = DrawTierCards(this.props.G), currentPlayerTurnUI = DrawCurrentPlayerTurn(this.props.ctx), currentPhaseStageUI = DrawCurrentPhaseStage(this.props.ctx), winnerUI = DrawWinner(this.props.G, this.props.ctx), drawDiscardCards = DrawDiscardedCards(this.props.G, this.props.ctx, null, this.props), marketCoinsUI = DrawMarketCoins(this.props.G, this.props), drawHeroesUI = DrawHeroes(this.props.G, this.props.ctx, null, this.props), drawHeroesForSoloBotUI = this.props.G.solo ?
