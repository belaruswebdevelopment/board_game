...
/**
 * Активирует обмен монет.
 * Применения:
 * 1) Когда заканчивается базовый выбор карты.
 *
 * @param G
 * @param ctx
...
/**
 * Определяет по расположению монет игроками порядок ходов и порядок обмена кристаллов приоритета.
 * Применения:
 * 1) После выкладки всех монет игроками.
 *
 * @param G
 * @param ctx
