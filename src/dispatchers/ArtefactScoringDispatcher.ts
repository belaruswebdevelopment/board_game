...
import type { IAction, IArtefactScoringFunction, MyFnContext, ScoringArgsType } from "../typescript/interfaces";
 ...
 */
export const StartArtefactScoring = ({ G, ctx, playerID, ...rest }: MyFnContext,
