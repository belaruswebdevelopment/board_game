...
import type { IAction, IArtefactScoringFunction, IMyGameState, IPublicPlayer, ScoringArgsType } from "../typescript/interfaces";
 ...
 */
export const StartArtefactScoring = (G: IMyGameState, player: IPublicPlayer,
